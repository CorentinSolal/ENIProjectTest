 ...
 */
final class Version20220822124311 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD campus_id INT NOT NULL, ADD lieu_id INT DEFAULT NULL, DROP etat');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD etat VARCHAR(255) NOT NULL, DROP campus_id, DROP lieu_id');
    }
}
